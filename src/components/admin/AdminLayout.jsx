  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex font-sans">
      ...
      <aside className="w-[260px] bg-[#0A101D] text-gray-400 flex flex-col h-screen sticky top-0 overflow-hidden shrink-0">
        ...
        {/* NAV ITEMS */}
        <nav className="flex-1 overflow-y-auto px-4 pb-6 space-y-6 scrollbar-hide mt-4">
              ...
              <div className="space-y-1">
                {group.items.map((item) => (
                  <NavLink
                    ...
                    to={item.path}
                    className={({ isActive }) =>
                      `flex items-center gap-3 px-4 py-3 rounded-xl transition-colors text-[14px] font-medium ${
                        isActive
