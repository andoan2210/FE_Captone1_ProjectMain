...
const DEFAULT_PRODUCTS = [
  { id: 1, name: 'iPhone 15 Pro Max 256GB', sku: 'APP-IP15PM-256', images: ['https://images.unsplash.com/photo-1696446701796-da61225697cc?w=100&h=100&fit=crop'], category: 'Điện thoại', price: '28.990.000', stock: 42, status: 'Đang hoạt động', updatedAt: '20/05/2024' },
  { id: 2, name: 'Tai nghe Sony WH-1000XM5', sku: 'SNY-WH1000XM5-B', images: ['https://images.unsplash.com/photo-1678253106197-03613725b7a7?w=100&h=100&fit=crop'], category: 'Phụ kiện', price: '8.490.000', stock: 3, status: 'Đang hoạt động', updatedAt: '18/05/2024' },
  { id: 3, name: 'Giày Nike Air Max 270', sku: 'NKE-AM270-W', images: ['https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=100&h=100&fit=crop'], category: 'Thời trang', price: '3.500.000', stock: 120, status: 'Tạm ẩn', updatedAt: '15/05/2024' }
];
